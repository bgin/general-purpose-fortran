#!/bin/bash
####################################################################################################################################
banner.sh getprograms.sh
GETPROGRAMS(){
#@(#) get some programs to add to the procedures
#
lastprogram sec2days.f90 sec2days.FF
lastprogram days2sec.f90 days2sec.FF
lastprogram now.f90 now.FF
lastprogram ttee.f90 ttee.FF
lastprogram month.f90 month.FF
lastprogram paws.f90 paws.FF
lastprogram today.f90 today.FF

lastprogram factors.f90 factors.FF
lastprogram lcm.f90 lcm.FF
lastprogram gcd.f90 gcd.FF
lastprogram quadratic.f90 quadratic.FF

lastprogram numdiff.f90 numdiff.FF
lastprogram what.f90 
lastprogram ufpp.f90 
lastprogram ufpp_template.f90 ufpp_template.FF
...
lastprogram pendulum.f90 pendulum.FF
lastprogram redo.f90 redo.FF
lastprogram rever.f90 rever.FF
lastprogram easter.f90 easter.FF
lastprogram planets.f90 
lastprogram lsup.f90 lsup.FF
lastprogram splitname.f90 splitname.FF
lastprogram model.f90 model.FF
lastprogram _cmp.f90 _cmp.FF
lastprogram _colrm.f90 _colrm.FF
lastprogram _dirname.f90 _dirname.FF
lastprogram _echo.f90 _echo.FF
lastprogram _false.f90 _false.FF
lastprogram _grep.f90 _grep.FF
lastprogram _hostname.f90 _hostname.FF
lastprogram _kill.f90 _kill.FF
lastprogram _ln.f90 _ln.FF
lastprogram _logname.f90 _logname.FF
lastprogram _ls.f90 _ls.FF
lastprogram _stat.f90 _stat.FF
lastprogram _mkdir.f90 _mkdir.FF
lastprogram _mkfifo.f90 _mkfifo.FF
...
lastprogram _sleep.f90 _sleep.FF
lastprogram _touch.f90 _touch.FF
lastprogram _true.f90 _true.FF
lastprogram _tty.f90 _tty.FF
lastprogram _uname.f90 _uname.FF
lastprogram _unlink.f90 _unlink.FF
...
lastprogram choose.f90 choose.FF
lastprogram fixedform.f90 fixedform.FF
lastprogram nc2html.f90 nc2html.FF
lastprogram setxt.f90 setxt.FF
