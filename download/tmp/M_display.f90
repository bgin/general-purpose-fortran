...
MODULE M_display
  ...
  PRIVATE  ! Everything not explicitly declared public should be private (including entities from M_display_util)
...
!>
!!##NAME
!!    tostring_disp_factory(3f) - [M_display] set DISP(3f) output back to original defaults
!!
!!##DESCRIPTION
!! The subroutine TOSTRING_DISP_FACTORY (which has no arguments) may be called to restore all
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_get', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_m_cpld', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_m_cplx', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_m_dble', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_m_dchr', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_m_dlog', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_m_sngl', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_matrix_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_s_cpld', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_s_cplx', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_s_dble', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_s_dlog', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_s_sngl', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_scalar_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_set', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_set_ds', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_set_factory', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_title_matrix_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_title_scalar_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_title_vector_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_tm_cpld', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_tm_cplx', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_tm_dble', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_tm_dchr', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_tm_dlog', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_tm_sngl', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_ts_cpld', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_ts_cplx', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_ts_dble', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_ts_dchr', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_ts_dlog', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_ts_sngl', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_tv_cpld', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_tv_cplx', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_tv_dble', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_tv_dchr', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_tv_dlog', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_tv_sngl', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_v_cpld', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_v_cplx', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_v_dble', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_v_dchr', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_v_dlog', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_v_sngl', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_vector_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('len_f_cpld', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('len_f_cplx', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('len_f_dble', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('len_f_dint', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('len_f_dlog', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('len_f_sngl', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('len_s_cpld', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('len_s_cplx', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_cpld', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_cplx', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_dble', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_dint', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_dlog', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_f_cpld', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_f_cplx', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_f_dble', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_f_dint', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_f_dlog', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_f_sngl', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_s_cpld', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_s_cplx', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_s_dble', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_s_dint', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_s_dlog', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_s_sngl', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_set', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_set_factory', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_sf_cpld', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_sf_cplx', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_sf_dble', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_sf_dint', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_sf_dlog', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_sf_sngl', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('check_settings', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('copyseptobox', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('copytobox', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('disp_errmsg', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('find_editdesc_real', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('finishbox', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('get_se', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('nnblk', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('preparebox', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('readfmt', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('replace_w', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('replace_zeronaninf', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_check_settings', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_get', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tostring_get_complex', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('trim_real', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('trim_s_real', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('upper', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('putnl', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('putstr', 0.eq.0. msg=msg('checking',100))
