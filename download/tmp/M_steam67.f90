...
character(len=*),parameter::ident_2="@(#)M_steam67::condl67(3f): return thermal conductivity given P,T"
...
character(len=*),parameter::ident_3="@(#)M_steam67::do67(3f)L summation of a polynomial"
...
character(len=*),parameter::ident_7="@(#)M_steam67::function critvs67(press, enth, gamma)"
character(len=*),parameter::ident_8="@(#)M_steam67::entry critvw67(press, enth, gamma)"
...
character(len=*),parameter::ident_9="@(#)M_steam67::critical flow(3f): velocity and isentropic exponent of wet/superheated steam"
...
character(len=*),parameter::ident_10="@(#)M_steam67::hcsl67(3f): calculate specific enthalpy/volume and entropy of liquid(P,T)"
...
character(len=*),parameter::ident_11="@(#)M_steam67::hcslvl67(3f): calculate V,S,specific enthalpy for liquid given (P,T)"
...
character(len=*),parameter::ident_13="@(#)M_steam67::hss67(3f): specific enthalpy = HSS67(P,T,s,v)"
character(len=*),parameter::ident_14="@(#)M_steam67::hsl67(3f): specific enthalpy = HSS67(P,T,s,v)"
...
character(len=*),parameter::ident_20="@(#)M_steam67::pls67(3f):  saturation pressure of the saturated liquid at entropy SS."
...
character(len=*),parameter::ident_26="@(#)M_steam67::gotoer67(3fp): print error message and stop program"
...
character(len=*),parameter::ident_27="@(#)M_steam67::steam67(3f):print pedigree of library and return version value"
...
character(len=*),intent(out) :: version
   ...
   write(io,*)'Build Target ....CYGWIN64_GFORTRAN'
   write(io,*)'System...........CYGWIN_NT-10.0'
   write(io,*)'O.S. Release.....2.10.0(0.325/5/3)'
...
!#cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
   ...
   write(io,*)'Compile Date:Mon Mar 18 22:00:53 EDT 2019'
   write(io,*)'******************************************************'
   endif
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('condl67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('condv67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('cpl67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('cpv67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('crflo67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('critvs67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('critvw67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('crvel67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('hcl67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('hcsl67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('hcslv167', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('hcslv267', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('hisiss67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('hpsiss67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('hsl67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('hss167', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('hss67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('hssicl67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('hssiss67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('hsv67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('pls67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('prliq67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('prstm67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('psl167', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('psl67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('psv167', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('psv267', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('psv67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('sisiss67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('spsiss67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('ssl67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('sssicl67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('sssiss67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('steamv67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tph67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tphl67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tps67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tpsl67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tsl167', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tsl67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('tslh67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('vcl67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('visl67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('visv67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('vsl67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('zsdh67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('zsdt67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('zsrh67', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('zsrt67', 0.eq.0. msg=msg('checking',100))
