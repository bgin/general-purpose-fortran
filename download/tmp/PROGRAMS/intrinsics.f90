...
'@(#)COMPILED:       Fri, Aug 30th, 2019 11:41:10 AM>',&
'']
...
write(io,'(a)')'o access to the Posix functions for file access'
...
write(io,'(a)')''
write(io,'(a)')'NAME select_type(3f) - [FORTRAN:EXECUTION_CONTROL] select_type'
write(io,'(a)')'SYNOPSIS'
write(io,'(a)')'     select_type()'
write(io,'(a)')'DESCRIPTION'
write(io,'(a)')'EXAMPLE'
write(io,'(a)')' Example'
write(io,'(a)')''
