...
'@(#)COMPILED:       Sun, Mar 18th, 2018 9:14:44 PM>',&
'']
...
write(io,'(a)')''
write(io,'(a)')'NAME'
write(io,'(a)')'  DEALLOCATE(3f) - [FORTRAN:STATEMENT] causes allocated variables and targets to be deallocated'
write(io,'(a)')''
write(io,'(a)')'SYNOPSIS'
write(io,'(a)')'  DEALLOCATE(allocate-object-list [,STAT=stat-variable][,ERRMSG=errmsg-variable] )'
write(io,'(a)')''
write(io,'(a)')'DESCRIPTION'
write(io,'(a)')'  The DEALLOCATE statement causes allocatable variables to be deallocated; it causes pointer targets to be'
write(io,'(a)')'  deallocated and the pointers to be disassociated.'
write(io,'(a)')''
write(io,'(a)')'  An allocate-object shall not depend on the value, bounds, allocation status, or association status of another'
write(io,'(a)')'  allocate-object in the same DEALLOCATE statement; it also shall not depend on the value of the stat-variable'
write(io,'(a)')'  or errmsg-variable in the same DEALLOCATE statement.'
write(io,'(a)')''
write(io,'(a)')'  The status of objects that were not successfully allocated or deallocated can be individually checked with'
write(io,'(a)')'  the intrinsic functions ALLOCATED or ASSOCIATED.'
write(io,'(a)')''
write(io,'(a)')'OPTIONS'
write(io,'(a)')''
...
write(io,'(a)')''
write(io,'(a)')'   Deallocating an unallocated allocatable variable causes an error condition in the DEALLOCATE statement.'
write(io,'(a)')'   Deallocating an allocatable variable with the TARGET attribute causes the pointer association status of any'
write(io,'(a)')'   pointer associated with it to become undefined.'
write(io,'(a)')''
write(io,'(a)')'   When the execution of a procedure is terminated by execution of a RETURN or END statement, an unsaved'
...
write(io,'(a)')''
write(io,'(a)')'   When a BLOCK construct terminates, an unsaved allocatable local variable of the construct is deallocated.'
write(io,'(a)')''
write(io,'(a)')'   If an executable construct references a function whose result is either allocatable or a structure with a subobj'
write(io,'(a)')'   that is allocatable, and the function reference is executed, an allocatable result and any subobject that is an'
write(io,'(a)')'   allocated allocatable entity in the result returned by the function is deallocated after execution of the innerm'
write(io,'(a)')'   executable construct containing the reference.'
write(io,'(a)')''
write(io,'(a)')'   If a function whose result is either allocatable or a structure with an allocatable subobject is referenced in t'
write(io,'(a)')'   specification part of a scoping unit or BLOCK construct, and the function reference is executed, an allocatable'
write(io,'(a)')'   result and any subobject that is an allocated allocatable entity in the result returned by the function is deall'
write(io,'(a)')'   before execution of the executable constructs of the scoping unit or block.'
write(io,'(a)')''
write(io,'(a)')'   When a procedure is invoked, any allocated allocatable object that is an actual argument corresponding to an'
write(io,'(a)')'   INTENT (OUT) allocatable dummy argument is deallocated; any allocated allocatable object that is a subobject'
write(io,'(a)')'   of an actual argument corresponding to an INTENT (OUT) dummy argument is deallocated.'
write(io,'(a)')''
write(io,'(a)')'   When an intrinsic assignment statement (7.2.1.3) is executed, any noncoarray allocated allocatable subobject of'
write(io,'(a)')'   the variable is deallocated before the assignment takes place.'
write(io,'(a)')''
write(io,'(a)')'   When a variable of derived type is deallocated, any allocated allocatable subobject is deallocated.'
write(io,'(a)')''
write(io,'(a)')'   If an allocatable component is a subobject of a finalizable object, that object is finalized before the componen'
write(io,'(a)')'   is automatically deallocated.'
write(io,'(a)')''
write(io,'(a)')'   The effect of automatic deallocation is the same as that of a DEALLOCATE statement without a dealloc-opt-list.'
write(io,'(a)')''
write(io,'(a)')''
write(io,'(a)')'   There is implicit synchronization of all images in association with each DEALLOCATE statement that deallocates'
write(io,'(a)')'   one or more coarrays. On each image, execution of the segment (8.5.1) following the statement is delayed until a'
write(io,'(a)')'   other images have executed the same statement the same number of times. If the coarray is a dummy argument,'
write(io,'(a)')'   its ultimate argument (12.5.2.3) shall be the same coarray on every image.'
write(io,'(a)')''
write(io,'(a)')'   There is also an implicit synchronization of all images in association with the deallocation of a coarray or coa'
write(io,'(a)')'   subcomponent caused by the execution of a RETURN or END statement or the termination of a BLOCK'
...
write(io,'(a)')''
write(io,'(a)')'    on return from subroutine PROCESS, the allocation status of X is preserved because X has the SAVE'
write(io,'(a)')'    attribute. TEMP does not have the SAVE attribute, so it will be deallocated if it was allocated. On the'
write(io,'(a)')'    next invocation of PROCESS, TEMP will have an allocation status of unallocated.'
write(io,'(a)')''
write(io,'(a)')'DEALLOCATION OF POINTER TARGETS'
write(io,'(a)')''
write(io,'(a)')'   If a pointer appears in a DEALLOCATE statement, its association status shall be defined. Deallocating a pointer'
write(io,'(a)')'    that is disassociated or whose target was not created by an ALLOCATE statement causes an error condition'
write(io,'(a)')'    in the DEALLOCATE statement. If a pointer is associated with an allocatable entity, the pointer shall not be'
write(io,'(a)')'    deallocated.'
write(io,'(a)')''
write(io,'(a)')'   If a pointer appears in a DEALLOCATE statement, it shall be associated with the whole of an object that was'
write(io,'(a)')'    created by allocation. Deallocating a pointer target causes the pointer association status of any other pointer'
write(io,'(a)')'    that is associated with the target or a portion of the target to become undefined.'
write(io,'(a)')''
write(io,'(a)')'   If an ALLOCATE or DEALLOCATE statement with a coarray allocate-object is executed when one or more'
write(io,'(a)')'   images has initiated termination of execution, the stat-variable becomes defined with the processor-dependent'
write(io,'(a)')'   positive integer value of the constant STAT STOPPED IMAGE from the intrinsic module ISO_FORTRAN_ENV (13.8.2).'
write(io,'(a)')'   If any other error condition occurs during execution of the ALLOCATE or DEALLOCATE'
write(io,'(a)')'   statement, the stat-variable becomes defined with a processor-dependent positive integer value different from'
write(io,'(a)')'   STAT STOPPED IMAGE. In either case, each allocate-object has a processor-dependent status:'
write(io,'(a)')''
write(io,'(a)')'       *·each allocate-object that was successfully allocated shall have an allocation status of allocated or a poi'
write(io,'(a)')'         association status of associated;'
write(io,'(a)')'      ·* each allocate-object that was successfully deallocated shall have an allocation status of unallocated or a'
write(io,'(a)')'         pointer association status of disassociated;'
write(io,'(a)')'      ·* each allocate-object that was not successfully allocated or deallocated shall retain its previous allocati'
write(io,'(a)')'         status or pointer association status.'
write(io,'(a)')''
write(io,'(a)')''
write(io,'(a)')'NAME'
...
write(io,'(a)')''
write(io,'(a)')'   end program test_get_command'
write(io,'(a)')''
...
write(io,'(a)')'   end program test_getenv'
write(io,'(a)')''
...
write(io,'(a)')''
write(io,'(a)')'    end program test_size'
write(io,'(a)')''
...
write(io,'(a)')'    o A namelist-group-object shall not have the PRIVATE attribute if the namelist-group-name has the PUBLIC attrib'
write(io,'(a)')''
write(io,'(a)')'   Any namelist-group-name may occur more than once in the NAMELIST statements in a scoping unit. The'
...
write(io,'(a)')''
write(io,'(a)')'   A namelist group object may be a member of more than one namelist group.'
write(io,'(a)')''
write(io,'(a)')'   A namelist group object shall either be accessed by use or host association or shall have its type, type paramet'
...
write(io,'(a)')'   open (7)              [FORTRAN:I/O] Initiates or modifies a connection between an external file and a specified'
...
write(io,'(a)')'   extends_type_of (3)   [FORTRAN:INTRINSIC] True if and only if the dynamic type of A is an extension of the dynam'
write(io,'(a)')'   findloc (3)           [FORTRAN:INTRINSIC] Location of the first element of ARRAY identified by MASK along dimens'
...
write(io,'(a)')'   definition can be found in the section Intrinsic Procedures of this'
write(io,'(a)')'   manual.'
write(io,'(a)')''
...
write(io,'(a)')'   REWIND ([UNIT=]file-unit-number][,IOMSG=iomsg-variable]'
write(io,'(a)')'          [,IOSTAT=scalar-int-variable][,ERR=label])'
write(io,'(a)')'DESCRIPTION'
