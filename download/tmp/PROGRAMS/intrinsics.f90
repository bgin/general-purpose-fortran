...
'@(#)COMPILED:       Fri, Sep 6th, 2019 9:09:50 PM>',&
'']
...
write(io,'(a)')''
write(io,'(a)')'NAME'
write(io,'(a)')'   return(7f) - [fortran] completes execution of the instance of the subprogram in which it appears'
write(io,'(a)')''
write(io,'(a)')'SYNOPSIS'
...
write(io,'(a)')'NAME'
write(io,'(a)')''
write(io,'(a)')'     logical(3f) - [FORTRAN:INTRINSIC:BIT MANIPULATION] Bitwise logical and'
write(io,'(a)')''
write(io,'(a)')'SYNTAX'
write(io,'(a)')''
...
write(io,'(a)')'NAME'
write(io,'(a)')'iso_c_binding(7f) - [FORTRAN]standard intrinsic module which defines named constants, types, and procedures for C i'
write(io,'(a)')''
write(io,'(a)')'SYNOPSIS'
write(io,'(a)')''
