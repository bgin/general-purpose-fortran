...
'@(#)COMPILED:       Fri, Mar 15th, 2019 9:47:38 AM>',&
'']
...
write(io,'(a)')''
write(io,'(a)')'NAME'
write(io,'(a)')'   IS_IOSTAT_END(3f) - [FORTRAN:INTRINSIC] True if and only if a value indicates an end-of-file condition.'
write(io,'(a)')'SYNOPSIS'
...
write(io,'(a)')'   Elemental function.'
write(io,'(a)')'NAME'
write(io,'(a)')'   IS_IOSTAT_EOR(3f) - [FORTRAN:INTRINSIC] True if and only if a value indicates an end-of-record condition.'
write(io,'(a)')'SYNOPSIS'
