...
write(io,'(a)')'  ######################################################################'
write(io,'(a)')'@EXPECTATIONS:@'
write(io,'(a)')''
write(io,'(a)')' If your program input could be specified on type-written forms and'
write(io,'(a)')' instructions, it should be as easy to create that interface on a computer'
write(io,'(a)')' as it would be to create those paper forms.'
write(io,'(a)')''
write(io,'(a)')' That is what FIXEDFORM is designed to do.'
write(io,'(a)')''
write(io,'(a)')'@OVERVIEW:@'
write(io,'(a)')''
...
write(io,'(a)')' line  arguments  to  a  command and  simple  data-input forms.'
write(io,'(a)')' It also allows for easy construction and access to basic  instructions'
write(io,'(a)')' for  supplying input  values.'
write(io,'(a)')''
...
write(io,'(a)')' documents using built-in functions.'
write(io,'(a)')''
...
write(io,'(a)')' The  programming interface is especially intended to be convenient for Fortran'
write(io,'(a)')' programs to use, which otherwise  often  run  only  in  command-line-interface'
write(io,'(a)')' environments.  A  minimal  amount  of  time  is  required  to  begin  creating'
write(io,'(a)')' applications that use it.  The forms are easily created using a text editor.'
write(io,'(a)')''
write(io,'(a)')''
...
write(io,'(a)')'################################################################################'
write(io,'(a)')'#                                                                              #'
write(io,'(a)')'#  ~ A basic form definition:         ~  ^ RED                                 #'
write(io,'(a)')'#  ~ o Underlines become input fields ~  ^ WHITE                               #'
write(io,'(a)')'#  ~ o Up-carets become menu options  ~  ^ BLUE                                #'
...
write(io,'(a)')'################################################################################'
write(io,'(a)')' By  default  all  that  is  returned  when the ctrl-S key is entered'
write(io,'(a)')' is a  character array composed of all the input fields, reading from'
write(io,'(a)')' left to right first and then down the form.  A  selected  menu  item'
write(io,'(a)')' returns  a  T character, otherwise it returns an F character. For larger'
write(io,'(a)')' forms with more than one selection per line it becomes  difficult  to'
write(io,'(a)')' ensure  which value  goes with  which  entry so you have to get more'
write(io,'(a)')' complicated. But for a small basic form that''s pretty much it.'
write(io,'(a)')''
...
write(io,'(a)')'          ~ o Up-carets become clickable menu options            ~'
write(io,'(a)')'          ~   When adjacent to a single row or column of pound   ~'
...
write(io,'(a)')''
write(io,'(a)')'@THE FUNCTION KEYS AND BOXES:@'
write(io,'(a)')''
write(io,'(a)')' PgUp and PgDn, Home, Help, End and Enter buttons at the screen bottom'
write(io,'(a)')' act in an intuitive fashion. The PgUp and PgDn boxes page thru large forms'
write(io,'(a)')' from top to bottom. The Home box puts the upper right corner of the form'
write(io,'(a)')' in the upper right corner of the scrolling region.  The Help box displays'
write(io,'(a)')' any help pages defined for the form. The End box ends the program. The'
write(io,'(a)')' Enter box submits the form data back to the calling program for processing.'
write(io,'(a)')'          ~ o The tab key goes to next input selection.          ~'
write(io,'(a)')''
write(io,'(a)')'################################################################################'
...
'@(#)AUTHOR:         John S. Urban>',&
'@(#)COMPILED:       Fri, Jun 14th, 2019 1:06:26 PM>',&
'']
