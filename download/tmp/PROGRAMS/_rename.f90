...
!>
!!##NAME
!!    _rename(1f) - [FUNIX:FILESYSTEM] rename files by replacing first occurrence of a string in a filename with new strin
!!
!!##SYNOPSIS
!!
!!    _rename old new file... [-verbose][-dryrun]|[-help|-version]
...
'@(#)COMPILED:       Fri, Jun 14th, 2019 12:31:56 PM>',&
'']
...
!-----------------------------------------------------------------------------------------------------------------------------------
   ...
   call kracken('rename','-help .false. -version .false. -c -verbose .false. -dryrun .false.')
!-----------------------------------------------------------------------------------------------------------------------------------
