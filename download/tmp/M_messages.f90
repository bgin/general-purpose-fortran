...
!!
!!##OPTIONS
!!    where  String used to indicate output disposition. See the descriptio
!!           of JOURNAL() for a meaning for the I/O flag. To write to stdou
!!           use 's'.
!!
!!##EXAMPLE
!!
...
!===================================================================================================================================
!>
!! DESCRIPTION: print eye-catching ASCII graphic (trolls) with messag
!! AUTHOR:      John S. Urban
...
!!    would produce:
!!
!!     >nn      nn    oooooooo    tttttttttt   iiiiiiiiii    cccccccc    eeeeeeeee
!!     >nnn     nn   oooooooooo   tttttttttt   iiiiiiiiii   cccccccccc   eeeeeeeee
...
!!     >nn     nnn   oooooooooo       tt       iiiiiiiiii   cccccccccc   eeeeeeeee
!!     >nn      nn    oooooooo        tt       iiiiiiiiii    cccccccc    eeeeeeeee
!===================================================================================================================================
!>
!! PROGRAM:     blocks(1F)
...
!! REFERENCES        : none
!! DEPENDENCIES      : none
!! LEGAL RESTRICTIONS: Copyright (c) 1984, 1996, John S. Urba
!! QA                : banner.f03
!! AUTHORS           : John S. Urban
...
!>
!!##NAME
!!    percent_done(3f) - [M_messages] non-advancing status counter displays percentage done on terminal display
!!
!!##SYNOPSIS
!!
