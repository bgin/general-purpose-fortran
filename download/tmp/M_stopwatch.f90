...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('create_watch_aa', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('create_watch_as', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('create_watch_sa', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('create_watch_ss', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('create_watchgroup_a', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('create_watchgroup_s', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('destroy_watch_aa', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('destroy_watch_as', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('destroy_watch_sa', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('destroy_watch_ss', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('destroy_watchgroup', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('end_pause_watch_aa', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('end_pause_watch_as', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('end_pause_watch_ga', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('end_pause_watch_gs', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('end_pause_watch_sa', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('end_pause_watch_ss', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('inquiry_stopwatch', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('join_watchgroup_a', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('join_watchgroup_s', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('leave_watchgroup_a', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('leave_watchgroup_s', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('option_stopwatch_a', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('option_stopwatch_s', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('pause_watch_aa', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('pause_watch_as', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('pause_watch_ga', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('pause_watch_gs', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('pause_watch_sa', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('pause_watch_ss', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('print_watch_aa', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('print_watch_as', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('print_watch_ga', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('print_watch_gs', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('print_watch_sa', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('print_watch_ss', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('read_watch_aa', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('read_watch_as', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('read_watch_ax', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('read_watch_sa', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('read_watch_ss', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('read_watch_sx', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('reset_watch_aa', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('reset_watch_as', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('reset_watch_ga', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('reset_watch_gs', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('reset_watch_sa', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('reset_watch_ss', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('start_watch_aa', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('start_watch_as', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('start_watch_ga', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('start_watch_gs', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('start_watch_sa', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('start_watch_ss', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('stop_watch_aa', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('stop_watch_as', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('stop_watch_ga', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('stop_watch_gs', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('stop_watch_sa', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('stop_watch_ss', 0.eq.0. msg=msg('checking',100))
