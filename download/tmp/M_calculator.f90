...
doubleprecision :: value
   ...
   call unit_check('stuff', value.eq. 31.415926535897931d0, msg=msg('check PI*10',value,31.415926535897931d0))
...
doubleprecision :: value
   ...
   call unit_check('getvalue', value.eq. 3.1415926535897931d0, msg=msg('check PI',value))
...
subroutine test_igetvalue()
   ...
   call unit_check('igetvalue', inum0('ten').eq.10, msg=msg('checking integer',inum0('ten')))
...
subroutine test_calculator()
   ...
   !!call unit_check('calculator', 0.eq.0, msg=msg('checking',100))
...
character(len=:),allocatable :: string
   ...
   call unit_check('stuffa', snum0('$mystring').eq.string, msg=msg('string check',snum0('$mystring')))
...
character(len=:),allocatable :: string
   ...
   string='10/3'
   call unit_check('inum0', inum0(string).eq.3, msg=msg('checking',string,'==>',inum0(string),'expected',3))
   string='(444/111+1)*10-5.0'
   call unit_check('inum0', inum0(string).eq.45, msg=msg('checking',string,'==>',inum0(string),'expected',45))
...
subroutine test_expression()
   ...
   !!call unit_check('expression', 0.eq.0, msg=msg('checking',100))
