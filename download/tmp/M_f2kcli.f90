...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('command_argument_count', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('get_command', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('get_command_argument', 0.eq.0. msg=msg('checking',100))
