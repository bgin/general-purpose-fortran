...
character(len=*),parameter::ident="@(#)M_exec::regcomp(3f): compile regular expression"
...
character(len=*),parameter::ident="@(#)M_exec::regexec(3f): Execute a compiled RE(regular expression) against a string"
...
character(len=*),parameter::ident="@(#)M_exec::regmatch(3f): return selected substrings defined by the regexec(3f) procedure"
...
character(len=*),parameter::ident="@(#)M_exec::regerror(3f): describe error generated by regcomp(3f) or regexec(3f)"
...
character(len=*),parameter::ident="@(#)M_exec::regfree(3f): release storage created by regcomp(3f) compiled regular expression"
...
character(len=*),parameter::ident="@(#)M_regex::regsub(3f): perform regex substitutions"
