...
!!    <a href="../PROGRAMS/huegif.f90">(huegif.f90)</a>
...
call unit_check_start('hue')
   ...
   call unit_check('hue',all([r.eq.  0.0,g.eq.100.0,b.eq.100.0 ]),msg('cyan cmy 100 0 0 to rgb',r,g,b))
   ...
   call unit_check('hue',all(abs([y-41.2999992,i-27.43087,q-52.2599983]).lt.0.10),msg=msg('rgb to yiq',y,i,q,'for green'))

   call hue('rgb',  0.0,100.0,  0.0,'yiq',y,i,q,status)
   call unit_check('hue',all(abs([ y-58.70147,i-(-27.43087),q-(-52.29881) ]).lt.0.10),msg=msg('rgb to yiq',y,i,q,'for magenta'))
