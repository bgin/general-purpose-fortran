...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_char', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_div_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_div_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_eq_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_eq_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_ge_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_ge_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_gets_char', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_gets_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_gt_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_gt_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_le_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_le_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_lt_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_lt_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_minus_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_minus_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_ne_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_ne_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_plus_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_plus_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_power_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_times_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('big_times_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('char_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('char_gets_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('char_gets_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('char_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('huge_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('int_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('int_char', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('int_div_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('int_eq_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('int_ge_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('int_gets_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('int_gets_char', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('int_gt_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('int_le_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('int_lt_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('int_minus_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('int_ne_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('int_times_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('modulo_big_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('modulo_big_int', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('modulo_int_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('print_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('random_number_big', 0.eq.0. msg=msg('checking',100))
...
use M_debug, only : unit_check_level
   ...
   !!call unit_check('sqrt_big', 0.eq.0. msg=msg('checking',100))
