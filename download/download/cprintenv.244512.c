...
*/
   ...
   while ((s = getopt(argc,argv,"Zp:l?uhv")) != EOF){
      ...
      case 'h':
         ...
         fprintf(stderr,"   and print them in the syntax of a csh(1) setenv command; like the\n");
         fprintf(stderr,"   printenv(1) command does for sh(1).\n");
         fprintf(stderr,"\n");
         ...
         fprintf(stderr,"   env(1) and printenv(1)  print the environment table in Bourne shell syntax; need capability to \n");
         fprintf(stderr,"   write variables in csh/tcsh syntax.\n");
         fprintf(stderr,"\n");
