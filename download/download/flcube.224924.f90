...
integer, parameter :: BLACK = 0, FACE = 1, FILLED = 2, OUTLINE = 3
...
use M_vogle
      ...
      integer obj
      integer BLACK, RED, GREEN, YELLOW, BLUE, CYAN, MAGENTA, WHITE, OUTLINE, FILLED, FACE
      parameter (BLACK = 0, RED = 1, GREEN = 2, YELLOW = 3, BLUE = 4, CYAN = 5, MAGENTA = 6, WHITE = 7)
