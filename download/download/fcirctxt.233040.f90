...
use M_vogle, only: vinit, vsetflush, color, clear, font, vexit, vflush
use M_vogle, only: ortho2, textang, boxtext, rect, textsize, getkey
use M_vogle
...
use M_vogle, only : move2, textang, drawchar
